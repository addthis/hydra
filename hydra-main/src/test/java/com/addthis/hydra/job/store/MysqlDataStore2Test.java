...
public class MysqlDataStore2Test {
    ...
    //class under test
    private MysqlDataStore2 mysqlDataStore;


    public MysqlDataStore2Test() {
    }
    ...
    public void setUp() throws Exception {
        ...
        mysqlDataStore = new MysqlDataStore2(DB_URL, "dbName", "tableName", properties);
    ...
    public void testGetDescription() {
        assertEquals("mysql2", mysqlDataStore.getDescription());
    }

...
/**
 * A class for managing task backups at the monthly level
 */
public class MonthlyBackup extends ScheduledBackupType {

    private final DateTimeFormatter dateTimeFormatter = new DateTimeFormatterBuilder().appendTwoDigitYear(2000).appendMonthOfYear(2).toFormatter();

    @Override
    public String getPrefix() {
        return backupPrefix + "monthly-";
    }

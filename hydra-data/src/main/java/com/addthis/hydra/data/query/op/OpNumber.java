 ...
 * <p/>
 * OP         := LOAD_OP | CALC_OP
 * LOAD_OP    :=  LOAD_COL | LOAD_NUM | LOAD_VAL
 * LOAD_COL   := ("c" | "col" ) INT ( ":" INT )*
 * LOAD_NUM   := ("n" | "num") FLOAT ( ":" FLOAT)*
 * LOAD_VAL   := ("v" | "val") FLOAT
 ...
 *
 * @user-reference
 * @hydra-name num or math
 */
public class OpNumber extends AbstractRowOp {
